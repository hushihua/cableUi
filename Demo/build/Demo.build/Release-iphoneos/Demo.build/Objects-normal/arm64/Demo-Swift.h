...
@interface AppDelegate (SWIFT_EXTENSION(Demo)) <UNUserNotificationCenterDelegate>
...
SWIFT_CLASS("_TtC4Demo23AutoLoginViewController")
@interface AutoLoginViewController : CUIBaseViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC4Demo8Constant")
@interface Constant : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC4Demo13IMDemoService")
@interface IMDemoService : PHHttpClient
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UITextField;

SWIFT_CLASS("_TtC4Demo19LoginViewController")
@interface LoginViewController : CUIBaseViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txUserName;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txPassword;
- (IBAction)onLogin;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC4Demo21RegeditViewController")
@interface RegeditViewController : CUIBaseViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txUserName;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txPassword;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txNickName;
- (IBAction)onRegister;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC4Demo13SceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
...
SWIFT_CLASS("_TtC4Demo21SessionViewController")
@interface SessionViewController : CUIBaseViewController
- (void)viewDidLoad;
- (IBAction)showVideoAlert;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC4Demo8UserInfo")
